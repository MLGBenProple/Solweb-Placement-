...
$catagory = $catagoryService ->getAll();
...
<body>
    <div class="container">
        <div class="jumbotron">
            ...
            <div class="row">
                <div class="col">
                <div class="button Home" onclick ="window.location='new.php'">New Catagory</div>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    ...
                    ?>
                    <a class="button" href="details.php?catagoryID=<?php echo $catagory->getID() ?>">
