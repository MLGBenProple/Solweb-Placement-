...
$attributes = $attributeService ->getAll();
...
<body>
    <div class="container">
        <div class="jumbotron">
            ...
            <div class="row">
                <div class="col">
                <div class="button Home" onclick ="window.location='new.php'">New Attribute</div>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    ...
                    ?>
                    <a class="button" href="details.php?attributeID=<?php echo $attribute->getID() ?>">
